...
_G.packer_plugins = {
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/start/goyo.vim",
  ...
  ["nim.vim"] = {
    loaded = true,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/start/nim.vim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["plantuml-syntax"] = {
    loaded = true,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/start/plantuml-syntax",
  ...
  ["tex-conceal.vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/opt/tex-conceal.vim",
  ...
  ultisnips = {
    loaded = true,
    path = "/Users/liam/.local/share/nvim/site/pack/packer/start/ultisnips",
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file ComposerStart lua require("packer.load")({'vim-markdown-composer'}, { cmd = "ComposerStart", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
